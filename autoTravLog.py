            ...
            try:
                ...
                for index, row in travLogR.iterrows() :
                    ...
                    if row[headers[head]] == 'R':
                        ...
                        sheet.cell(row=s,column=14).value = foodPrice["Déjeuner"]
                        sheet.cell(row=s,column=15).value = foodPrice["Dîner"]
                        sheet.cell(row=s,column=16).value = foodPrice["Souper"]
            ...
            try :
                ...
                for index, row in travLogV.iterrows() :
                    ...
                    if row[headers[head]] == 'V':
                        ...
                        sheet.cell(row=s,column=10).value = foodPrice["V"] 
            ...
            try :
                ...
                for index, row in travLogCV.iterrows() :
                    ...
                    if row[headers[head]] == 'CV':
                        ...
                        sheet.cell(row=s,column=13).value = foodPrice["CV"]
